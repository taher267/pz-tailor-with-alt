...
<head>
  ...
  <!-- overlayScrollbars -->
  <link rel="stylesheet" href="{{'assets/alt/plugins/overlayScrollbars/css/OverlayScrollbars.min.css'}}">
</head>
...
<!-- jQuery UI 1.11.4 -->
<script src="{{'assets/alt/plugins/jquery-ui/jquery-ui.min.js'}}"></script>
...
<!-- overlayScrollbars -->
<script src="{{'assets/alt/plugins/overlayScrollbars/js/jquery.overlayScrollbars.min.js'}}"></script>
<!-- AdminLTE App -->
<script src="{{'assets/alt/dist/js/adminlte.js'}}"></script>
<!-- AdminLTE for demo purposes -->
<script src="{{'assets/alt/dist/js/demo.js'}}"></script>
</body>
</html>
