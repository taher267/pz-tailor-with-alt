    ...
    <div class="card">
        <div class="container">
            ...
            <div class="card-body p-0">
                @foreach ($ordersItems as $ik => $item)
                @php
                ...
                <!--Per item calculation and print and edit End-->
                    <div class="my-2 measurementPrint-1-{{$item->id}}">
                            <div class="row print-date-time- d-none" style="display: flex">
                                <div class="col-md-2"><span>অর্ডার নং-<b>{{$item->order_number}}</b>-<i>({{$item->order_management_id}}-{{$item->id}})</i> </span></div>
                                ...
                                <div class="right-part">
                                    {{-- <table>
                                        <tbody>
                                            ...
                                            <tr class="">
                                                <td></td>
                                                <td colspan="3"><!--অর্ডার নং--><b>{{$item->order_number}}</b>-<i>({{$item->order_management_id}}-{{$item->id}})</i></td>
